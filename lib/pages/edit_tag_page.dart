...
class _EditTagPageState extends State<EditTagPage> {
  ...
  void initState() {
    ...
    _tagColorController.text = widget.tag.color;
    currentColor = Color(int.parse(widget.tag.color.replaceFirst('#', '0xff')));
  ...
  Future<void> _saveTag() async {
    ...
    widget.tag.name = _tagNameController.text;
    widget.tag.description = _descriptionController.text;
    widget.tag.color = _tagColorController.text.isNotEmpty
    ...
    try {
      await TagStorageService.updateTag(widget.tag);
    } catch (e) {
      setState(() {
        isLoading = false;
      });
